...
public class Keypad extends Frame implements ActionListener {
	...
	public Keypad() {
		...
		add(display, BorderLayout.NORTH); // =add(display, BoarderLayout.NORTH);
...
//		btn1.addActionListener(new KeyButton());
//		panel.add(btn1);
	...
	class KeyButton extends Button{
		...
		public KeyButton(String label){
			super(label);
			addActionListener(Keypad.this); //keybutton 이라는 클래스의 this 를 뜻함
		}
	}
